...
class B4M64 extends Module {
  val io = IO(new Bundle {
    val in  = Flipped(Decoupled(new b4m_in(64)))
    val out = Decoupled(new b4m_out(64))
  ...
  val special_product = Wire(UInt((64 * 2).W))
  ...
  // 创建 stage 链
  val booth4 = Module(new booth4_gen(64))
  val pp = Module(new pp_gen(64))
  val wallace = Module(new wallace_gen(64))
